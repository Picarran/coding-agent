  ...
  <div class="metrics">
    ...
    <template v-else>
      <div class="m-cards">
        ...
        <div class="m-card"><div class="k">成本</div><div class="v">${{ data.aggregate.cost_usd }}</div></div>
      ...
      <table class="m-table">
        <thead>
          <tr><th>任务</th><th>输入</th><th>输出</th><th>成本</th><th>LLM</th><th>工具</th><th>耗时</th></tr>
        </thead>
        <tbody>
          ...
          <tr v-if="!data.tasks.length"><td colspan="7" class="empty">暂无</td></tr>
        </tbody>
      </table>
    </template>
  </div>
